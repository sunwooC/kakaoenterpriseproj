 ...
 * (Authorization Code Grant)</a>
 */
public final class MyDefaultAuthorizationCodeTokenResponseClient
	...
	public MyDefaultAuthorizationCodeTokenResponseClient() {
	...
	public OAuth2AccessTokenResponse getTokenResponse(
		...
		acessToken = tokenResponse.getAccessToken().getTokenValue();
		map.put(acessToken, refreshToken);
